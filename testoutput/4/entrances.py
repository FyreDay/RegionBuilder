...
class EntranceTypeEnum(Enum):
    def __init__(self, value: str, exiting_region: RegionTypeEnum, entering_region: RegionTypeEnum, transition_type: int, rule):
...
class Entrances(EntranceTypeEnum):    
    TEST_REGION_1_TO_IDK_WHAT = ("Test Region 1_To_idk what", Regions.TEST_REGION_1, Regions.IDK_WHAT, 0, True_())
